...
p1 <- sim2.500 %>% 
  ...
  geom_line() +
  labs(title = "n = 500, k = 0.01", x = "Generation", y = "Allele Frequency") +
  theme(plot.title = element_text(size = 10))

p4 <- sim2.5000 %>% 
  ggplot(aes(x = generation, y = allele.freq)) +
  geom_line() +
  labs(title = "n = 5000, k = 0.01", x = "Generation", y = "Allele Frequency")+
  theme(plot.title = element_text(size = 10))

p2 <- sim2.500.2 %>% 
  ggplot(aes(x = generation, y = allele.freq)) +
  geom_line() +
  labs(title = "n = 500, k = 0.001", x = "Generation", y = "Allele Frequency")+
  theme(plot.title = element_text(size = 10))

p5 <- sim2.5000.2 %>% 
  ggplot(aes(x = generation, y = allele.freq)) +
  geom_line() +
  labs(title = "n = 5000, k = 0.001", x = "Generation", y = "Allele Frequency")+
  theme(plot.title = element_text(size = 10))

p3 <- sim2.500.3 %>% 
  ggplot(aes(x = generation, y = allele.freq)) +
  geom_line() +
  labs(title = "n = 500, k = 0.0001", x = "Generation", y = "Allele Frequency")+
  theme(plot.title = element_text(size = 10))

p6 <- sim2.5000.3 %>% 
  ggplot(aes(x = generation, y = allele.freq)) +
  geom_line() +
  labs(title = "n = 5000, k = 0.0001", x = "Generation", y = "Allele Frequency")+
  theme(plot.title = element_text(size = 10))
